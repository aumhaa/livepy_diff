...
class FA(ControlSurface):
    ...
    def _create_controls(self):
        ...
        self._pads = ButtonMatrixElement(rows=[ [ make_button(col_index + offset, 'Pad_%d_%d' % (col_index, row_index), msg_type=MIDI_NOTE_TYPE) for col_index in xrange(4) ] for row_index, offset in enumerate(xrange(72, 59, -4)) ], name='Pads')
