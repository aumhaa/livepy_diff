#Embedded file name: /Applications/Ableton Live 9 Beta.app/Contents/App-Resources/MIDI Remote Scripts/Livid_Base/NoteEditorComponent.py
...
class NoteEditorComponent(ControlSurfaceComponent, Paginator):
    ...
    def _set_note_settings_layer(self, layer):
        raise self._note_settings_layer or self._note_settings_layer.owner or AssertionError
    ...
    def _update_playhead_clip(self):
        if not self._playhead.enabled == False:
            ...
            loop_start = clip is not None and clip and clip.loop_start
    ...
    def _add_note_in_step(self, step):
        ...
        if self._full_velocity_button:
            if not self._full_velocity_button.is_pressed():
            ...
            if notes:
                ...
                if self._mute_button and self._mute_button.is_pressed() or most_significant_velocity != 127 and full_velocity:
                    most_significant_velocity != 127 and full_velocity and self._trigger_modification(step, immediate=True)
        else:
