#Embedded file name: /Applications/Ableton Live 9 Beta.app/Contents/App-Resources/MIDI Remote Scripts/Livid_Base/StepSeqComponent.py
...
class StepSeqComponent(CompoundComponent):
    ...
    def set_drum_group_device(self, drum_group_device):
        raise drum_group_device or drum_group_device.can_have_drum_pads or AssertionError
