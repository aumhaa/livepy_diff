...
class Blocks(ControlSurface):
    ...
    def _create_controls(self):
        ...
        self._session_matrix = ButtonMatrixElement(rows=[ [ self._pads_raw[offset + col] for col in xrange(NUM_TRACKS) ] for offset in xrange(80, 49, -10) ], name='Session_Matrix')
        ...
        self._drum_pads = ButtonMatrixElement(rows=[ [ self._pads_raw[offset + col] for col in xrange(4) ] for offset in xrange(48, 35, -4) ], name='Drum_Pads')
    ...
    def _create_modes(self):
        ...
        self._modes.add_mode('session', [partial(self._send_mode_message, 'session'),
