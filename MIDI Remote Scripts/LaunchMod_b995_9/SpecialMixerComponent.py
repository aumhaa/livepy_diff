#Embedded file name: /Applications/Ableton Live 9.05 Suite.app/Contents/App-Resources/MIDI Remote Scripts/LaunchMod_b995_9/SpecialMixerComponent.py
import Live
...
class SpecialMixerComponent(MixerComponent):
    ...
    def set_global_buttons(self, unarm_all, unsolo_all, unmute_all):
        if not isinstance(unarm_all, (ButtonElement, type(None))):
            ...
            self._unmute_all_button != None and self._unmute_all_button != None and self._unmute_all_button.add_value_listener(self._unmute_all_value)
