#Embedded file name: /Applications/Ableton Live 9 Beta.app/Contents/App-Resources/MIDI Remote Scripts/CNTRLR_9/ModDevices.py
ENDCODER_BANK_CONTROL1 = ['ModDevice_knob0',
 'ModDevice_knob1',
 'ModDevice_knob2',
 'ModDevice_knob3']
ENDCODER_BANK_CONTROL2 = ['ModDevice_knob4',
 'ModDevice_knob5',
 'ModDevice_knob6',
 'ModDevice_knob7']
