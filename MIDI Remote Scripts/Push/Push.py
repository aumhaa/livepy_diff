...
from ableton.v2.control_surface.mode import AddLayerMode, EnablingModesComponent, LazyComponentMode, ModesComponent
...
class Push(PushBase):
    ...
    def _init_browse_mode(self):
        ...
        self._main_modes.add_mode(u'add_effect_right', [self._when_track_is_not_frozen(self._enable_stop_mute_solo_as_modifiers, self._browser_back_to_top, LazyComponentMode(self._create_create_device_right))], behaviour=mixin(ExcludingBehaviourMixin, CancellableBehaviour)([u'add_track', u'browse']), groups=[u'add_effect'])
        self._main_modes.add_mode(u'add_effect_left', [self._when_track_is_not_frozen(self._enable_stop_mute_solo_as_modifiers, self._browser_back_to_top, LazyComponentMode(self._create_create_device_left))], behaviour=mixin(ExcludingBehaviourMixin, CancellableBehaviour)([u'add_track', u'browse']), groups=[u'add_effect'])
        ...
        self._main_modes.add_mode(u'add_default_track', [self._enable_stop_mute_solo_as_modifiers, self._browser_back_to_top, LazyComponentMode(self._create_create_default_track)], groups=[u'add_track'])
