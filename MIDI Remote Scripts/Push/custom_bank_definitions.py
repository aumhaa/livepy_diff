...
BANK_DEFINITIONS = {u'AudioEffectGroupDevice': RACK_BANKS,
 ...
 u'Tube': IndexedDict(((u'Character', {PARAMETERS_KEY: (u'Drive',
                              ...
                              u'Output',
                              u'Dry/Wet')}))),
 u'Echo': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'L Sync',
                              use(u'L Sync Mode').if_parameter(u'L Sync').has_value(u'On'),
           ...
           (u'Left', {PARAMETERS_KEY: (u'Link',
                              ...
                              u'Feedback Inv',
                              u'Dry Wet')}),
           (u'Right', {PARAMETERS_KEY: (u'Link',
                              u'R Sync',
                              use(u'R Sync Mode').if_parameter(u'R Sync').has_value(u'On'),
 ...
 u'StereoGain': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Mute',
                                    use(u'BlockDc').if_parameter(u'Mute').has_value(u'off'),
                                    use(u'PhaseInvertL').if_parameter(u'Mute').has_value(u'off'),
                                    use(u'PhaseInvertR').if_parameter(u'Mute').has_value(u'off'),
                                    use(u'Signal Source').if_parameter(u'Mute').has_value(u'off'),
                                    use(u'Panorama').if_parameter(u'Mute').has_value(u'off'),
                                    use(u'').if_parameter(u'Mute').has_value(u'on').else_use(u'').if_parameter(u'Signal Source').has_value(u'Left').else_use(u'').if_parameter(u'Signal Source').has_value(u'Right').else_use(u'StereoSeparation'),
                                    use(u'Gain').if_parameter(u'Mute').has_value(u'off'))}),)),
