...
BANK_DEFINITIONS = {u'AudioEffectGroupDevice': RACK_BANKS,
 ...
 u'StereoGain': IndexedDict(((u'Utility', {PARAMETERS_KEY: (use(u'').if_parameter(u'Channel Mode').has_value(u'Right').else_use(u'Left Inv').if_parameter(u'Mute').has_value(u'off'),
                                    ...
                                    use(u'').if_parameter(u'Mute').has_value(u'on').else_use(u'').if_parameter(u'Channel Mode').has_value(u'Left').else_use(u'').if_parameter(u'Channel Mode').has_value(u'Right').else_use(u'').if_parameter(u'Mono').is_available(True).and_parameter(u'Mono').has_value(u'on').else_use(u'Stereo Width').if_parameter(u'Stereo Width').is_available(True).else_use(u'Stereo Separation (Legacy)'),
