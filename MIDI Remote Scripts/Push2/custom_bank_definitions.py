...
BANK_DEFINITIONS = {'AudioEffectGroupDevice': RACK_BANKS,
 ...
 'OriginalSimpler': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use('Ve Attack').if_parameter('Multi Sample').has_value('on').else_use('Zoom'),
                                        ...
                                        use('Transpose').if_parameter('Multi Sample').has_value('on').else_use('Transpose').if_parameter('Mode').has_value('One-Shot').else_use('Slice by').if_parameter('Secret Slicing').has_value('on').and_parameter('Mode').has_value('Slicing').else_use('Pad Slicing').if_parameter('Secret Slicing').has_value('off').and_parameter('Mode').has_value('Slicing').else_use('S Loop Length').if_parameter('Mode').has_value('Classic'),
                                        use('Detune').if_parameter('Multi Sample').has_value('on').else_use('Gain').if_parameter('Mode').has_value('One-Shot').else_use('Sensitivity').if_parameter('Secret Slicing').has_value('on').and_parameter('Slice by').has_value('Transient').and_parameter('Mode').has_value('Slicing').else_use('Division').if_parameter('Secret Slicing').has_value('on').and_parameter('Slice by').has_value('Beat').and_parameter('Mode').has_value('Slicing').else_use('Regions').if_parameter('Secret Slicing').has_value('on').and_parameter('Slice by').has_value('Region').and_parameter('Mode').has_value('Slicing').else_use('Pad Slicing').if_parameter('Secret Slicing').has_value('on').and_parameter('Slice by').has_value('Manual').and_parameter('Mode').has_value('Slicing').else_use('Sensitivity').if_parameter('Mode').has_value('Slicing').else_use('S Loop Fade').if_parameter('Mode').has_value('Classic').and_parameter('Warp').has_value('off').else_use('Detune'),
                       ...
                       OPTIONS_KEY: (use('').if_parameter('Multi Sample').has_value('on').else_use('Loop').if_parameter('Mode').has_value('Classic').else_use('Trigger Mode'),
                                     ...
                                     use('').if_parameter('Multi Sample').has_value('on').else_use('Clear Slices').if_parameter('Secret Slicing').has_value('on').and_parameter('Slice by').has_value('Manual').and_parameter('Mode').has_value('Slicing').else_use('Reset Slices').if_parameter('Secret Slicing').has_value('on').and_parameter('Mode').has_value('Slicing'),
                                     use('').if_parameter('Multi Sample').has_value('on').else_use('Split Slice').if_parameter('Secret Slicing').has_value('on').and_parameter('Mode').has_value('Slicing').else_use('Crop'),
