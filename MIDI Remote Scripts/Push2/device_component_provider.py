...
class DeviceComponentProvider(ModesComponent):
    ...
    def __init__(self, device_component_layer = None, device_decorator_factory = None, banking_info = None, device_bank_registry = None, device_provider = None, delete_default_component = None, *a, **k):
