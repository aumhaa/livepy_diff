#Embedded file name: /Applications/Ableton Live 9.05 Suite.app/Contents/App-Resources/MIDI Remote Scripts/_Mono_Framework/MonoDeviceComponent.py
import Live
            ...
            for host in self._parent._active_host:
                if host.is_enabled():
                    ...
                    if hasattr(host, '_device_component'):
                        if host._device_component is not None:
